...
public partial class TalentTree : Control
{
	...
	public override void _Ready()
	{
		...
		_tooltipScene = GD.Load<PackedScene>("res://skill-tree/weapon_tooltip.tscn");
	...
	public virtual void _on_talent_button_pressed()
	{
		...
		GetTree().ChangeSceneToFile("res://skill-tree/talent_tree.tscn");
	}
	...
	public virtual void _on_weapon_button_pressed()
	{
		if (_isChangingScene) return;
		_isChangingScene = true;
		GetTree().ChangeSceneToFile("res://skill-tree/weapon_ui.tscn");
	}
	...
	public virtual void _on_inventory_button_pressed()
	{
		if (_isChangingScene) return;
		_isChangingScene = true;
		GetTree().ChangeSceneToFile("res://skill-tree/inventory_ui.tscn");
	}
}
